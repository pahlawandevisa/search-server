...
/**
 * Class DiskStoragePluginExtension.
 */
class DiskStoragePluginExtension extends BaseExtension
{
    /**
    ...
    {
        return new DiskStoragePluginConfiguration($this->getAlias());
    }
    ...
    {
        return [
            'apisearch_plugin.disk_storage.locator_enabled' => $config['locator_enabled'],
            'apisearch_plugin.disk_storage.reload_reads' => \boolval(Env::get('DISK_STORAGE_RELOAD_ON_READS', $config['reload_reads'])),
            'apisearch_plugin.disk_storage.path' => Env::get('DISK_STORAGE_PATH', $config['path']),
        ];
    }
}
